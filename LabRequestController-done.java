...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User loggedInTester = userLoggedInService.getLoggedInUser(); //getting logged in tester
        return testRequestQueryService.findByTester(loggedInTester); //getting test requests assigned to tester
