...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // replace this line of code with your implementation
        User loggedInDoctor = userLoggedInService.getLoggedInUser(); // getting logged in doc
        return testRequestQueryService.findByDoctor(loggedInDoctor); // getting all test requests assigned to  doc
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            // replace this line of code with your implementation
            User loggedInDoctor = userLoggedInService.getLoggedInUser(); // getting  logged in doctor
            return testRequestUpdateService.assignForConsultation(id,loggedInDoctor); // assigning the given test request(by id) to doctor
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            return testRequestUpdateService.updateConsultation(id,testResult,loggedInDoctor);// update the given consultation info 
